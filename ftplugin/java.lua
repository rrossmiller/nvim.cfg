...
local config = {
    ...
    java = {
      format = {
        settings = {
          ...
          -- url = "/.local/share/jdtls/eclipse-java-google-style.xml",
          -- url = "/.local/share/jdtls/intellij-java-google-style.xml",
          url = "/.local/share/jdtls/google.xml",
          profile = "GoogleStyle",
        },
      },
  ...
  cmd = {
    ...
    "-jar",
    vim.fn.glob("/opt/homebrew/Cellar/jdtls/" .. jdtls_version .. "/libexec/plugins/org.eclipse.equinox.launcher_*.jar"),

    -- The configuration for jdtls is also placed where jdtls was installed. This will
    -- need to be updated depending on your environment
    "-configuration",
    "/opt/homebrew/Cellar/jdtls/" .. jdtls_version .. "/libexec/config_mac_arm",
